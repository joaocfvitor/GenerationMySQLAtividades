...
SELECT * FROM tb_produtos WHERE preco IN (2,3,5);
SELECT * FROM tb_produtos WHERE preco BETWEEN 10 AND 15;
SELECT * FROM tb_produtos WHERE nome LIKE "%ra%"; -- dois % significa que busca a informação em qualquer lugar
SELECT * FROM tb_produtos WHERE nome LIKE "%ra"; -- % no começo significa que busca apenas no final do nome 
SELECT * FROM tb_produtos WHERE nome LIKE "ra%"; -- % no final significa que busca apenas no começo do nome
